    ...
    >
      ...
      >
        ...
        <div className="relative aspect-[4/3] w-full overflow-hidden rounded-xl">
            ...
            <>
              <Image
                ...
                className={`object-cover transition-opacity duration-500 ${
                  img1 ? 'opacity-100 group-hover:opacity-0' : ''
                }`}
              />
              {img1 && (
                <Image
          ...
          {/* Acciones flotantes (no deben navegar) */}
          <div className="pointer-events-none absolute inset-0 flex items-end justify-center">
            <div
              className="pointer-events-auto mb-3 hidden gap-2 rounded-full bg-white/90 p-1 shadow-sm backdrop-blur
            ...
            >
              ...
              <button
                ...
                onClick={(e) => {
                  ...
                  e.stopPropagation();
                  toggle(p.slug);
                  toast(wish ? 'Quitado de favoritos' : 'Añadido a favoritos');
                }}
              >
                ♥
              </button>
        ...
        <div className="mt-3 space-y-1">
          <div className="line-clamp-2 font-semibold group-hover:underline">{p.name}</div>
      ...
      {/* Botón principal (fuera del Link, no navega) */}
      <button
        disabled={out}
        onClick={() => {
          addToCart(p.slug, 1);
