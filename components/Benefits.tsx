...
export default function Benefits() {
  ...
  return (
    <section ref={sectionRef} className="container py-10 md:py-16">
        ...
        {items.map((item, idx) => (
          ...
          >
            ...
            `}>
              ...
              `}>
                <div className={`transition-all duration-300 ${hoveredCard === idx ? 'rotate-12 scale-125' : 'group-hover:rotate-6'
                  }`}>
                  {item.icon}
                </div>
      ...
      <div className={`mt-8 text-center transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
        }`}>
